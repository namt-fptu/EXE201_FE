    ...
    try {
      ...
      if (response.data) {
        ...
        if (Array.isArray(categoryData)) {
          // Transform API categories to options format
          const categoryOptions = [
            { label: "All Categories", value: "0" }, // Keep "All Categories" as first option
          ...
          <div className="flex w-full lg:w-auto items-center gap-7.5">
            ...
            <div className="flex w-full lg:w-auto justify-between items-center gap-5">
              <div className="flex items-center gap-5">
                ...
                {/* Wishlist button - only show when user is signed in */}
                {isAuthenticated() && user && (
                  <Link href="/wishlist" className="flex items-center gap-2.5">
                    <span className="inline-block relative">
                      ...
                      {/* You can add a counter here if you have wishlist items count */}
