        ...
        <div className="p-6 sm:p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              {touched.packageName && fieldValidations.packageName && (
                <div className="flex items-center gap-1 text-red-500">
                  ...
                  <span className="text-sm">{fieldValidations.packageName}</span>
                </div>
              )}
              {touched.packageName && !fieldValidations.packageName && formData.packageName && (
              ...
              <div className="relative">
                ...
                {formData.price && !fieldValidations.price && (
                  <div className="absolute right-3 top-3 text-sm text-gray-500">
                    {new Intl.NumberFormat('vi-VN').format(parseFloat(formData.price) || 0)} VND
                  </div>
                )}
              </div>
              {touched.price && fieldValidations.price && (
            ...
            <div className="space-y-2">
              ...
              {touched.postLimit && !fieldValidations.postLimit && formData.postLimit && (
                <div className="flex items-center gap-1 text-green-500">
                  <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                  </svg>
            ...
            <div className="space-y-2">
              ...
              {touched.durationInDays && fieldValidations.durationInDays && (
                <div className="flex items-center gap-1 text-red-500">
                  ...
                  <span className="text-sm">{fieldValidations.durationInDays}</span>
                </div>
              )}
              {touched.durationInDays && !fieldValidations.durationInDays && formData.durationInDays && (
                <div className="flex items-center gap-1 text-green-500">
                  <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                  </svg>
