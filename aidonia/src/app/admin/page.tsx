        ...
        <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-green-600 dark:text-green-400">+8.2% from last month</p>
            </div>
        ...
        <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-green-600 dark:text-green-400">+23.1% from last month</p>
            </div>
        ...
        <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-red-600 dark:text-red-400">-0.8% from last month</p>
            </div>
            ...
            {[
              ...
              <div key={index} className="flex items-center gap-4 p-3 bg-gray-50 dark:bg-gray-700/50 rounded-lg">
                <div className={`p-2 rounded-lg ${
                  ...
                  activity.type === 'package' ? 'bg-green-100 dark:bg-green-900/30' :
                  activity.type === 'system' ? 'bg-yellow-100 dark:bg-yellow-900/30' :
                  'bg-purple-100 dark:bg-purple-900/30'
                }`}>
                  <div className={`w-4 h-4 ${
                    activity.type === 'user' ? 'text-blue-600 dark:text-blue-400' :
                    activity.type === 'package' ? 'text-green-600 dark:text-green-400' :
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500 dark:text-gray-400">Create and edit packages</p>
                </div>
              </div>
            </Link>
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500 dark:text-gray-400">Check platform metrics</p>
                </div>
              </div>
            </Link>
